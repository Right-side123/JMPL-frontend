...
function NotConnectedCallsPage() {
    ...
    const fetchCdrData = async () => {
        ...
        try {
            const response = await axios.get('http://localhost:7700/api/notconnectedcalls/', {
                params: {
                    startDate,
                    endDate,
                    startTime,
    ...
    return (
        <div>
            <Header />
            <div className="NotConnectedCdrPage">
                <h1 className='notconnectedpage_heading'>Not Connected Calls</h1>
...
export default NotConnectedCallsPage;
