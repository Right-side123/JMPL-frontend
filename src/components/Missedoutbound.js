...
function MissedOutboundCallsPage() {
    ...
    const downloadExcel = () => {
        ...
        XLSX.writeFile(wb, 'Missed Outbound Calls.xlsx');
    };
    ...
    return (
        <div>
            <Header />
            <div className="failedCdrPage">
                <h1 className='failedpage_heading'>Missed Outbound Calls</h1>
...
export default MissedOutboundCallsPage;
