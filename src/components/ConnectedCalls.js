...
function ConnectedCallsPage() {
    ...
    const fetchCdrData = async () => {
        ...
        try {
            const response = await axios.get('http://localhost:7700/api/connectedcalls', {
                params: {
                    startDate,
                    endDate,
                    startTime,
    ...
    return (
        <div>
            <Header />
            <div className="ConnectedCdrPage">
                <h1 className='connectedpage_heading'>Connected Calls</h1>
...
export default ConnectedCallsPage;
